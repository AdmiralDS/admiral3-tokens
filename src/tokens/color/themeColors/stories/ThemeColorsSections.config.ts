...
const descriptions = {
  neutral: {
    base: {
      _1: 'Основной цвет фона страниц и форм',
      _2: 'Альтернативный цвет фона страниц и форм',
      _3: 'Третичный цвет фона',
      _4: 'Редкие сценарии',
    ...
    text: {
      _1: 'Основной цвет текста',
      _2: 'Вторичный цвет текста, основной цвет иконок',
      _3: 'Третичный цвет текста',
    ...
    stroke: {
      _1: 'Основной цвет линий, разделителей',
      _2: 'Цвет обводки различных компонентов',
  ...
  primary: {
    base: {
      _1: 'Основной интерактивный цвет фонов',
      _2: 'Вторичный цвет фонов',
      _3: 'Третичный интерактивный цвет фонов',
      inverted: 'Инвертированный интерактивный цвет фонов',
    },
    text: {
      _1: 'Основной интерактивный цвет текста и иконок',
      link: 'Основной интерактивный цвет текста и иконок',
      inverted: 'Инвертированный интерактивный цвет текста и иконок',
    },
    stroke: {
      _1: 'Основной цвет линий и обводок',
      _2: 'Вторичный цвет линий и обводок',
      _3: 'Третичный цвет линий и обводок',
